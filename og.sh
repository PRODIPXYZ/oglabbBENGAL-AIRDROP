...
print_header() {
    ...
    echo -e "${YELLOW}${BOLD}║    _ __   ___ _ __   ___  __ _  ___ ___  _ __  _ __ ___          ║${NC}"
    echo -e "${YELLOW}${BOLD}║   | '_ \\ / _ \\ '_ \\ / _ \\/ _\` |/ __/ _ \\| '_ \\| '__/ __|         ║${NC}"
    echo -e "${YELLOW}${BOLD}║   | |_) |  __/ |_) |  __/ (_| | (_| (_) | |_) | |  \\__ \\         ║${NC}"
    echo -e "${YELLOW}${BOLD}║   | .__/ \\___| .__/ \\___|\\__,_|\\___\\___/| .__/|_|  |___/         ║${NC}"
    echo -e "${YELLOW}${BOLD}║   |_|        |_|                       |_|                      ║${NC}"
    echo -e "${YELLOW}${BOLD}╚═════════════════════════════════════════════════════════════════╝${NC}"
