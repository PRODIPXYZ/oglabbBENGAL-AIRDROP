...
print_header() {
    ...
    echo -e "${YELLOW}${BOLD}║  ____ ____  _   _ ____   _    _ _______ ______     _ ____  ____   ____   ║${NC}"
    echo -e "${YELLOW}${BOLD}║ | __ ) __ )| \\ | | __ ) | |  | |__   __|  ____|   | | __ )|  _ \\ / __ \\  ║${NC}"
    echo -e "${YELLOW}${BOLD}║ |  _ \\  _ \\|  \\| |  _ \\ | |  | |  | |  | |__      | |  _ \\| |_) | |  | | ║${NC}"
    echo -e "${YELLOW}${BOLD}║ | |_) | |_) | |\\  | |_) || |__| |  | |  |  __|     | | |_) |  _ <| |  | | ║${NC}"
    echo -e "${YELLOW}${BOLD}║ |____/|____/|_| \\_|____/  \\____/   |_|  |____|     |_|____/|_| \\_\\____/  ║${NC}"
    echo -e "${YELLOW}${BOLD}╚═════════════════════════════════════════════════════════════════════════╝${NC}"
